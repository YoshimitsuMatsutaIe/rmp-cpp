 ...
 ******************************************************************************/
#include "../../include/baxter/o_6.hpp"
#include <cmath>
using std::cos;
using std::sin;
using std::sqrt;
