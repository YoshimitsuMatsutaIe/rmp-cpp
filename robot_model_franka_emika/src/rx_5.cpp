...
void franka_emika::Kinematics::rx_5(const VectorXd& q, VectorXd& out) {
   ...
   out(1) = sin(q(0))*sin(q(1))*sin(q(3))*cos(q(4))*cos(q(5)) + sin(q(0))*sin(q(1))*sin(q(5))*cos(q(3)) - sin(q(0))*sin(q(2))*sin(q(4))*cos(q(1))*cos(q(5)) - sin(q(0))*sin(q(3))*sin(q(5))*cos(q(1))*cos(q(2)) + sin(q(0))*cos(q(1))*cos(q(2))*cos(q(3))*cos(q(4))*cos(q(5)) - sin(q(2))*sin(q(3))*sin(q(5))*cos(q(0)) + sin(q(2))*cos(q(0))*cos(q(3))*cos(q(4))*cos(q(5)) + sin(q(4))*cos(q(0))*cos(q(2))*cos(q(5));
   out(2) = sin(q(1))*sin(q(2))*sin(q(4))*cos(q(5)) + sin(q(1))*sin(q(3))*sin(q(5))*cos(q(2)) - sin(q(1))*cos(q(2))*cos(q(3))*cos(q(4))*cos(q(5)) + sin(q(3))*cos(q(1))*cos(q(4))*cos(q(5)) + sin(q(5))*cos(q(1))*cos(q(3));
