...
void baxter::Rz_W0(VectorXd& out) {
...
void baxter::Rz_BR(VectorXd& out) {
...
void baxter::Rz_0(const VectorXd& q, VectorXd& out) {
...
void baxter::Rz_1(const VectorXd& q, VectorXd& out) {
...
void baxter::Rz_2(const VectorXd& q, VectorXd& out) {
...
void baxter::Rz_3(const VectorXd& q, VectorXd& out) {
...
void baxter::Rz_4(const VectorXd& q, VectorXd& out) {
...
void baxter::Rz_5(const VectorXd& q, VectorXd& out) {
...
void baxter::Rz_6(const VectorXd& q, VectorXd& out) {
...
void baxter::Rz_ee(const VectorXd& q, VectorXd& out) {
