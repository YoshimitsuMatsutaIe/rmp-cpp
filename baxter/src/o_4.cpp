...
void baxter::o_4(const VectorXd& q, double L, double h, double H, double L0, double L1, double L2, double L3, double L4, double L5, double L6, VectorXd& out) {
   ...
   out(2) = H + L0 - L2*sin(q(1)) - L3*cos(q(1))*cos(q(2)) - L4*sin(q(1))*cos(q(3)) - L4*sin(q(3))*cos(q(1))*cos(q(2));
