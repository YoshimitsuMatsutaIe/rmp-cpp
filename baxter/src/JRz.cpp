...
void baxter::Baxter::JRz_W0(const Vector7d& q, Matrix_3_7_d& out) {
...
void baxter::Baxter::JRz_BR(const Vector7d& q, Matrix_3_7_d& out) {
...
void baxter::Baxter::JRz_0(const Vector7d& q, Matrix_3_7_d& out) {
...
void baxter::Baxter::JRz_1(const Vector7d& q, Matrix_3_7_d& out) {
...
void baxter::Baxter::JRz_2(const Vector7d& q, Matrix_3_7_d& out) {
...
void baxter::Baxter::JRz_3(const Vector7d& q, Matrix_3_7_d& out) {
...
void baxter::Baxter::JRz_4(const Vector7d& q, Matrix_3_7_d& out) {
   ...
   out(0,1)= (-0.5*M_SQRT2*sin(q(0)) + 0.5*M_SQRT2*cos(q(0)))*sin(q(3))*cos(q(1))*cos(q(2)) - (0.5*M_SQRT2*sin(q(0)) - 0.5*M_SQRT2*cos(q(0)))*sin(q(1))*cos(q(3));
...
void baxter::Baxter::JRz_5(const Vector7d& q, Matrix_3_7_d& out) {
...
void baxter::Baxter::JRz_6(const Vector7d& q, Matrix_3_7_d& out) {
...
void baxter::Baxter::JRz_ee(const Vector7d& q, Matrix_3_7_d& out) {
