...
namespace baxter
{
    ...
    // const double L6;
    // const double R;
    // const VectorXd Q_NEUTRAL(7);
    // const VectorXd Q_MAX(7);
    // const VectorXd Q_MIN(7);


    const double L = 278e-3;
    const double h = 64e-3;
    const double H = 1104e-3;
    const double L0 = 270.35e-3;
    const double L1 = 69e-3;
    const double L2 = 364.35e-3;
    const double L3 = 69e-3;
    const double L4 = 374.29e-3;
    const double L5 = 10e-3;
    const double L6 = 368.3e-3;
    const double R = 0.05;
    ...
    vector<vector<vector<double>>> R_BARS_ALL{
